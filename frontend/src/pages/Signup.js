  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <input onChange={handleChange} name="name"     placeholder="Name"     style={styles.input} />
        <br /><br />
        <input onChange={handleChange} name="email"    placeholder="Email"    style={styles.input} />
        <br /><br />
        <input onChange={handleChange} name="password" placeholder="Password" type="password" style={styles.input} />
        <br /><br />
...
const styles = {
  ...
  btn:       { padding: "12px 30px", fontSize: "16px", backgroundColor: "#2ecc71", color: "white", border: "none", borderRadius: "5px", cursor: "pointer", fontWeight: "bold" },
